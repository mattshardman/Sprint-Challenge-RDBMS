...
* RDBMS is the system itself i.e. it controls the adding, updating, deleting of data & managing relationships etc. SQL is the query language that interacts with the system
1. Why do tables need a `primary key`?
* To give each row a unique reference that can be referenced easily
